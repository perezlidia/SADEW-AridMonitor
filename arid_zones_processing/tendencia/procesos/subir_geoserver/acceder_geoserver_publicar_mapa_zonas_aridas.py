...
def constructor(prMapa,prYear,prdirectorio):      
    ...
    filter.send_keys("tend_zonas_aridas_" + year)
    ...
    try:
        ...
        driver.find_element(By.XPATH, '//*[text()="'+mapa+'"]').click()
        ...
        for option in selectsrsHandling.find_elements_by_tag_name('option'):
            if option.get_attribute("innerText") == 'za_zonas_aridas':
                option.click()
                break
...
if __name__ == '__main__':
    constructor(sys.argv[1], sys.argv[2], sys.argv[3])