				...
				elementos: [
				  {
					...
					visible: false, 
					url: 'http://'+config.getServidorGeoserver()+'/geoserver/catastro/ows?service=WMS&layers=catastro:vias_comunicacion&request=GetMap&version=1.1.0&srs=EPSG:32613&format=image/png',
					url_simbologia: 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=catastro:vias_comunicacion&STYLE=C_vias_comunicacion'
				  },
				  {
					nombre: 'Hidrografía', 
					...
					visible: false, 
					url: 'http://'+config.getServidorGeoserver()+'/geoserver/catastro/ows?service=WMS&layers=catastro:hidrografia&request=GetMap&version=1.1.0&srs=EPSG:32613&format=image/png',
					url_simbologia: 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=catastro:hidrografia&STYLE=C_hidrografia'
				  },
				  {
					...
					url_simbologia: 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=catastro:uso_suelo_vegetacion&STYLE=C_uso_suelo_vegetacion'
				  },
						...
						for (k = 0; k <= 6; k++) { //categorias siempre las mismas
							...
							if(k == 0){
								...
								for (j = 0; j < 5; j++) {
									...
									if(j == 0){
										item.nombre = 'Precipitación ' + year
										item.id_collapse = 'collapsetend_var_precipitacion_' + year
										item.capa = 'tend_var_precipitacion_' + year
										item.id_opacidad = 'tend_var_precipitacion_' + year + '|Opacidad'
										item.visible = false
										item.url = 'http://'+config.getServidorGeoserver()+'/geoserver/zonas_aridas/ows?service=WMS&layers=zonas_aridas:tend_var_precipitacion_'+year+'&request=GetMap&version=1.1.0&srs=EPSG:6372&format=image/png'
										item.url_simbologia = 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=zonas_aridas:tend_var_precipitacion_'+year+'&STYLE=za_1precipitacion'
										
									}else if(j == 1){
										item.nombre = 'Evapotranspiración ' + year
										item.id_collapse = 'collapsetend_var_evapotranspiracion_' + year
										item.capa = 'tend_var_evapotranspiracion_' + year
										item.id_opacidad = 'tend_var_evapotranspiracion_' + year + '|Opacidad'
										item.visible = false
										item.url = 'http://'+config.getServidorGeoserver()+'/geoserver/zonas_aridas/ows?service=WMS&layers=zonas_aridas:tend_var_evapotranspiracion_'+year+'&request=GetMap&version=1.1.0&srs=EPSG:6372&format=image/png'
										item.url_simbologia = 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=zonas_aridas:tend_var_evapotranspiracion_'+year+'&STYLE=za_4evapotranspiracion'
										
									}else if(j == 2){
										item.nombre = 'Humedad ' + year
										item.id_collapse = 'collapsetend_var_humedad_' + year
										item.capa = 'tend_var_humedad_' + year
										item.id_opacidad = 'tend_var_humedad_' + year + '|Opacidad'
										item.visible = false
										item.url = 'http://'+config.getServidorGeoserver()+'/geoserver/zonas_aridas/ows?service=WMS&layers=zonas_aridas:tend_var_humedad_'+year+'&request=GetMap&version=1.1.0&srs=EPSG:6372&format=image/png'
										item.url_simbologia = 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=zonas_aridas:tend_var_humedad_'+year+'&STYLE=za_5humedad'
										
									}else if(j == 3){
										item.nombre = 'Temperatura ' + year
										item.id_collapse = 'collapsetend_var_temperatura_' + year
										item.capa = 'tend_var_temperatura_' + year
										item.id_opacidad = 'tend_var_temperatura_' + year + '|Opacidad'
										item.visible = false
										item.url = 'http://'+config.getServidorGeoserver()+'/geoserver/zonas_aridas/ows?service=WMS&layers=zonas_aridas:tend_var_temperatura_'+year+'&request=GetMap&version=1.1.0&srs=EPSG:6372&format=image/png'
										item.url_simbologia = 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=zonas_aridas:tend_var_temperatura_'+year+'&STYLE=za_2temperatura'
										
									}else{
										item.nombre = 'Indice De Vegetación ' + year
										item.id_collapse = 'collapsetend_var_indiceDeVegetacion_' + year
										item.capa = 'tend_var_indiceDeVegetacion_' + year
										item.id_opacidad = 'tend_var_indiceDeVegetacion_' + year + '|Opacidad'
										item.visible = false
										item.url = 'http://'+config.getServidorGeoserver()+'/geoserver/zonas_aridas/ows?service=WMS&layers=zonas_aridas:tend_var_indicedevegetacion_'+year+'&request=GetMap&version=1.1.0&srs=EPSG:6372&format=image/png'
										item.url_simbologia = 'http://'+config.getServidorGeoserver()+'/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=zonas_aridas:tend_var_indicedevegetacion_'+year+'&STYLE=za_3ndvi'
							...
							ls.on("close", code => {
								switch(code){
									case 4:
										...
										res.status(200).json({"code" : 200, "data" : {"status" : 4, "year": yearConvert, "mensaje" : "El proceso a finalizado correctamente."}});
										res.end();
										break;
									case 99:
										res.json({"code" : 200, "data" : "Proporcione el año a procesar."});
										break;
									case 2:
										res.json({"code" : 200, "data" : "El año no se puede procesar."});
										break;
									case 3:
										res.json({"code" : 200, "data" : "El año ya esta procesado."});
										break;
									case 5:
										res.json({"code" : 200, "data" : "El proceso se finalizo por que se produjerón 3 intentos erroneos."});
										break;
									default:
										res.json({"code" : 200, "data" : "Se ha generado un error al procesar el año."});
										break;
								}
							});	*/
